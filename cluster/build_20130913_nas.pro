...
;
; EXAMPLE:
;   IDL > .r build_20130913_nas.pro
;   IDL > build_20130913_nas
;
;
...
pro build_20130913_nas

;set the proper directories
date='20130913'  ;date
vv='v2'  ; version string
;pw=5./9.2*(18.3+9.2)
...
indir ='/nobackupp8/sleblan2/rtm/input/'+vv+'_'+date+'/'  ;'/lustre/janus_scratch/leblanse/cloud/input/'+vv+'_'+date+'/';'/scratch/stmp00/leblanse/cloud/input/'
outdir='/nobackupp8/sleblan2/rtm/output/'+vv+'_'+date+'/' ;'/lustre/janus_scratch/leblanse/cloud/output/'+vv+'_'+date+'/';'/scratch/stmp00/leblanse/cloud/output/'
...
atm_file='/nobackup/sleblan2/dat/atmos_aero_20130913_at.dat.dat'
;alb_file='/nobackup/sleblan2/dat/alb_20130913_1841.dat';snow_albedo.dat'; albedo_2012-05-24.dat'
alb_file='/nobackup/sleblan2/dat/alb_20130913_mean.dat'

uvspec_p='/home5/sleblan2/libradtran/libRadtran-1.7/bin/uvspec'

zout=[8.0,19.0] & albedo=0.2
  for t=0, n_elements(tau)-1 do begin
    for r=0, n_elements(ref)-1 do begin
       cloud=[tau[t],ref[r],10.0,6.5]
